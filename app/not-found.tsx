...
const Not_Found_Page = () => {
    return (
        <main className="grid h-screen place-items-center bg-white px-6 py-6 ">
            <div className="w-full h-full flex-col justify-start items-center lg:gap-16 gap-10 inline-flex">
                <div className="border border-emerald-300 h-full rounded-lg w-full">
                    <div className="p-8 flex justify-between items-center border-b border-emerald-100">
                        <div className="block">
                            <svg
                                width={204}
                                height={18}
                    ...
                    <div className="relative h-[calc(550px-85px)] flex justify-center items-center flex-col">
                        ...
                        <div className="block text-center mt-5">
                            <h5 className="md:text-xl text-lg leading-8 text-gray-900 font-medium mb-1.5">
                                <span className="text-emerald-600 font-semibold ">Oops!</span> Trang bạn tìm kiếm không tồn tại.
                            </h5>
